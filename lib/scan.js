...
module.exports = function scanDirectory(directory, _config, cb) {
    ...
    var config = _.merge({ filter: /.*/, migrations: {} }, _config)
    ...
    function buildMigration(file, script, cb) {
        ...
        cb(null, _.merge({}, config.migrations, { level: level, comment: comment, script: script }))
    }
